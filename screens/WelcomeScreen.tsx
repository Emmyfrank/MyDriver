...
const WelcomeScreen: React.FC = () => {
    ...
    const images: Array<Item> = [{
        ...
        title: "Welcome To MyDrive",
        description: "Welcome to MyDrive app where you can find drivers and passangers for easy way and good plices"
    },
    {
        id: "2",
        image: require("../assets/2.png"),
        title: "Hollaaa",
        description: "Find the best possible way to Find a driver and passanger nearby your desired destination"
    },
    {
        id: "3",
        image: require("../assets/3.png"),
        title: "Find Your Ride ",
        description: "Find your perfect driver and passenger around wherever you are."
    }
    ]
    ...
    return (
        <View style={styles.container}>
                <Text onPress={()=>navigation.navigate("mapScreen" as never)} style={[styles.skip, styles.description]}>Skip</Text>
            <View>
                <FlatList
                    data={images}
            ...
            <View style={{ width: '90%' }}>
                <TouchableOpacity onPress={() => navigation.navigate("loginbyemail" as never)}>
                    <Button />
                </TouchableOpacity>
                ...
                <View style={{ flexDirection: "row", justifyContent: "center" }}>
                    <Text style={styles.signup}onPress={()=>navigation.navigate("notificationsScreen"as never)}>Don't have an account?
                    </Text>
                    <Pressable onPress={() => navigation.navigate("myDriveHome" as never)}>
